...
## Description
Given an array of size N-1 containing distinct integers in the range 1 to N, write a C program to find the single integer that is missing from the sequence.
