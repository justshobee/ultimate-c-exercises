...
## Description
Implement a C program to search for a target value in a sorted array using the highly efficient binary search algorithm. The program should return the index of the element if found.
